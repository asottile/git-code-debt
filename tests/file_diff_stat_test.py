...
MERGE_COMMIT_OUTPUT = b"""commit 42a3a7c8b2141a5d8069e7b83e744d13d335fa17
...
FILE_ADDED_COMMIT = b"""commit c1fa89d4f38a9f8784495d38c8c385977178cb3d
...
COMMIT_WITH_TERRIBLE = b"""commit blahblahblah
...
COMMIT_ADDING_SYMLINK = br"""diff --git a/pa2 b/pa2
...
COMMIT_REMOVING_SYMLINK = br"""diff --git a/pa2 b/pa2
...
COMMIT_MOVING_SYMLINK = br"""diff --git a/pa2 b/pa2
...
MULTIPLE_EMPTY_FILES = b"""diff --git a/foo/__init__.py b/foo/__init__.py
new file mode 100644
...
MODE_CHANGE_COMMIT = b"""diff --git a/EECS485PA3_W13.pdf b/EECS485PA3_W13.pdf
old mode 100755
new mode 100644
"""

ADD_SUBMODULE_COMMIT = b"""diff --git a/.gitmodules b/.gitmodules
...
REMOVE_SUBMODULE_COMMIT = b"""diff --git a/.gitmodules b/.gitmodules
index e69de29..c8af28a 100644
--- a/.gitmodules
+++ b/.gitmodules
@@ -0,0 +1,3 @@
...
BUMP_SUBMODULE_COMMIT = b"""diff --git a/verifycppbraces b/verifycppbraces
...
ADD_BINARY_COMMIT = b"""diff --git a/foo.pdf b/foo.pdf
new file mode 100644
index 0000000..2aaa277
Binary files /dev/null and b/foo.pdf differ
"""

REMOVE_BINARY_COMMIT = b"""diff --git a/foo.pdf b/foo.pdf
deleted file mode 100644
index 2aaa277..0000000
Binary files a/foo.pdf and /dev/null differ
"""

MODIFY_BINARY_COMMIT = b"""diff --git a/foo.pdf b/foo.pdf
...
def test_add_submodule():
    ...
    assert ret == [
        ...
        FileDiffStat(
            b'verifycppbraces', [], [], Status.ADDED,
            special_file=SpecialFile(
                file_type=SpecialFileType.SUBMODULE,
                added=b'72053d85133aa854e2762a4b604976da825750fb',
                removed=None,
            ),
        ),
    ]
